...
urlpatterns = [
    ...
    path('admin_dashboard/forms/<str:category>/manage',
         views.manage_forms, name='manage_forms'),
    path('admin_dashboard/forms/<str:category>/manage/add_question/<int:form_id>/',
         views.add_question, name='add_question'),
    path('admin_dashboard/forms/<str:category>/manage/view_form/<int:form_id>/',
